...
void verifyJupyterInstallation(){
	f= createProcess("printenv", args=["JUPYTER_HOME"]);
	JUPYTER_HOME = replaceAll(readEntireStream(f),"\n","");
	if(JUPYTER_HOME == "")
		throw "JUPYTER_HOME not defined as environment variable";
}
/*
...
/*
* This function reads the logs generated by the Jupyter Server.
*/
...
void printTrace(PID pid){
	for (line := readWithWait(pid, 200), line != "") {
		println("<line>");
    }
}
